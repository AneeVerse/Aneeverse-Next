...
const page = async () => {
    ...
    const items = [
        { name: "Product Listing Update", about: "SEO-optimized titles, bullets, backend keywords, and A+ refresh for top SKUs", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Product%20Listing%20Resized.png?updatedAt=1782714090604", bgColor: "bg-secondary-500", textColor: "text-primary-500" },
