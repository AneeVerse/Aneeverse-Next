...
const page = async () => {
    ...
    const scrollServices = [
        { title: "Amazon Listing Optimization", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Product%20Listing%20Resized.png?updatedAt=1782714090604" },
        { title: "Brand Store & A+ Content", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/A+%20Content%20Module%20Libary%20Resized.png?updatedAt=1782714094560" },
        { title: "Amazon Ads Setup", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/PPC%20Campaign%20Architecture%20Resized.png?updatedAt=1782714088154" },
        { title: "FBA Support", image: "/images/services/website/design-systems.avif" },
        { title: "Account Health Management", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Amazon%20account%20health%20Resized.png?updatedAt=1782714090970" },
        { title: "Orders & Returns Management", image: "/images/services/website/ux-ui-audit.avif" },
        { title: "Performance Reporting", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Weekly%20performace%20Resized.png?updatedAt=1782714085617" },
    ];

    const items = [
        { name: "Product Listing Overhaul", about: "SEO-optimized titles, bullets, backend keywords, and A+ refresh for top SKUs", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Product%20Listing%20Resized.png?updatedAt=1782714090604", bgColor: "bg-secondary-500", textColor: "text-primary-500" },
        ...
        { name: "A+ Content Module Library", about: "Comparison charts, feature callouts, lifestyle blocks designed for conversion", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/A+%20Content%20Module%20Libary%20Resized.png?updatedAt=1782714094560", bgColor: "bg-[#f9f9f9]", textColor: "text-[#3d3d3d]" },
        { name: "PPC Campaign Architecture", about: "Auto, manual, product targeting, and brand defense campaigns", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/PPC%20Campaign%20Architecture%20Resized.png?updatedAt=1782714088154", bgColor: "bg-[#292423]", textColor: "text-[#ffafed]" },
        { name: "Search Term Harvesting", about: "Converting queries turned into new keywords and negative lists", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Serach%20term%20Harvesting%20Resized.png?updatedAt=1782714093860", bgColor: "bg-[#d8ff85]", textColor: "text-[#1c4437]" },
        ...
        { name: "Suppressed ASIN Recovery", about: "Policy fixes and case escalations to restore live listings", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Amazon%20account%20health%20Resized.png?updatedAt=1782714090970", bgColor: "bg-[#e7f9d1]", textColor: "text-[#365314]" },
        { name: "Deals & Coupons Calendar", about: "Lightning Deals and coupon stack strategy by margin", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Deals%20and%20coupon%20Resized.png?updatedAt=1782714093913", bgColor: "bg-[#f6edf9]", textColor: "text-[#4a124f]" },
        ...
        { name: "Weekly Performance Scorecard", about: "Sales, CVR, ACoS/TACoS, ranking movement, and priority actions", image: "https://ik.imagekit.io/Aneeverse/AV_creatives_new/AV_Image/SERVICES%20&%20INTERNAL/E-Commerce/Weekly%20performace%20Resized.png?updatedAt=1782714085617", bgColor: "bg-[#e6f3ff]", textColor: "text-[#003366]" },
    ];
