...
const page = async () => {
  ...
  const scrollServices = [
    { title: "SEO blog writing", image: "/images/services/website/content-development.avif" },
    { title: "Long-form content creation", image: "/images/services/website/website-illustrations.avif" },
    { title: "Keyword research & strategy", image: "/images/services/website/website-strategy.avif" },
    { title: "Industry / niche authority blogs", image: "/images/services/website/ux-ui-audit.avif" },
    { title: "Content calendars & planning", image: "/images/services/website/design-systems.avif" },
    { title: "SEO optimization & on-page editing", image: "/images/services/website/webflow-development.avif" },
    { title: "Performance tracking & analytics", image: "/images/services/website/landing-page-design.avif" },
  ];
  const items = [
    {
