const WEBHOOK_URL =
  process.env.ADS_DIGITAL_MARKETING_VISITOR_WEBHOOK_URL ||
  "https://script.google.com/macros/s/AKfycby9NNkVuxrq1a4kxiiggAMHpLbkHpHdWmdykkdjBTp9D-CinC1s3b3Geij91dPmygAc5g/exec";
...
export async function POST(req) {
  try {
    ...
    console.error("track-ads-digital-marketing-visitor error:", err);
