...
const ContactSection = () => {
  ...
  return (
    <div className="bg-black text-white py-12 mt-[100px]">
      ...
      <div className="bg-white text-black -mt-[130px] py-8 rounded-xl px-8 shadow-lg mx-auto max-w-lg md:max-w-3xl md:flex md:items-center md:justify-between space-y-4 md:space-y-0">
      ...
      <div className="mt-16">
        <div className="container mx-auto px-4">
          ...
          <h2 className="font-semibold mb-2 text-lg">Contact</h2>
              <p className="mb-2">+1-(707)-240-8320</p>
