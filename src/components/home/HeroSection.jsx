...
const HeroSection = () => {
  ...
  // ✅ Scroll-based parallax for card columns
  ...
  return (
    <div className="bg-[#073742]  relative text-[#EBFAFE] overflow-x-hidden">
      {/* Overlap */}
      <div className="absolute top-[-40px] left-0 w-full h-[80px] bg-gradient-to-b z-20 blur-sm from-secondary-500 via-secondary-500 to-secondary-500 opacity-92"></div>
      ...
      <div className="relative">
        <Layout>
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            {/* Left Content */}
            <div className="pt-[290px]  lg:pt-[355px] lg:pb-32">
              <div className="flex flex-col sm:flex-col" style={{ transform: 'translateY(-28px)' }}>
                <Heading
                  level="h2"
                  color="gredient"
                  spacing="lg"
        ...
        <div className="hidden lg:block absolute right-[1%] top-0 w-[42%] lg:w-[45%] xl:w-[42%] 2xl:w-[40%] h-full pb-8 overflow-hidden">
          {/* Desktop View - Vertical Scroll */}
          <div className="flex gap-3 h-screen md:max-h-[950px] xl:max-h-[1000px] 2xl:max-h-[1050px] overflow-hidden">
            <div className="w-1/3 marquee-vertical" style={{ transform: `translateY(${-scrollY * 0.3}px)`, transition: 'transform 0.1s ease-out' }}>
              <div className="marquee-vertical-content space-y-4">
            ...
            <div className="w-1/3 marquee-vertical-reverse" style={{ transform: `translateY(${scrollY * 0.3}px)`, transition: 'transform 0.1s ease-out' }}>
              <div className="marquee-vertical-content space-y-4">
        ...
        <Layout>
          <div className="lg:hidden space-y-4 overflow-hidden pb-8">
