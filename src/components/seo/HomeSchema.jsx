...
const HomeSchema = () => {
  useEffect(() => {
    // Remove existing home schema if it exists
    const existingScript = document.querySelector('script[data-schema="home"]');
    if (existingScript) {
      existingScript.remove();
    }

    // Create comprehensive home schema for Aneeverse
    const homeSchema = {
    ...
    // Cleanup function
    return () => {
      const scriptToRemove = document.querySelector('script[data-schema="home"]');
      if (scriptToRemove) {
