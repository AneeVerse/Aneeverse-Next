...
const steps = [
  ...
  },
  {
    ...
    text: "Our team looks at your goals and current marketing setup.",
  },
  {
    icon: <FaChartLine className="w-4 h-4" />,
    title: "Clear next step",
    text: "You'll get a tailored plan and a call scheduled within 24 hours.",
  },
];

export default function AdsDigitalMarketingThankYou() {
  useEffect(() => {
        ...
        <div className="flex items-center justify-center h-full py-6">
          <div className="w-full max-w-2xl text-center">
            ...
            <p className="text-sm sm:text-base text-white/85 leading-relaxed max-w-xl mx-auto mb-6 sm:mb-8">
              Our digital marketing team is reviewing your request.
              You&apos;ll hear from us within <span className="text-white font-semibold">24 hours</span> to schedule your free call.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="/ads-digital-marketing#our-works"
