...
export default function BlogWritingHero() {
  return (
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh]  sm:min-h-[500px] sm:h-[75vh] flex items-center">
        ...
        <div className="relative  z-10">
          ...
          {"Content That Engages & Converts".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2">Blog Writing Services
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Transform your brand’s online presence with compelling blog content. Our expert writers craft engaging, SEO-friendly articles that drive traffic, boost credibility, and enhance audience engagement.
