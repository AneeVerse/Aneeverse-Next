...
const BlogWritingSupportSection = () => {
  return (
    <section className="bg-primary-500 py-16">
      <Layout className="flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          {"High-Quality Blog Content That Engages".toUpperCase()}
          </p>
          <h1 className="text-4xl lg:text-5xl font-bold text-secondary-500 mb-6 leading-snug">     Blog Writing That{" "}
          ...
          Establish your brand’s authority with well-researched, engaging, and SEO-friendly blog content. 
          ...
          From **SEO-optimized blogs** to **thought leadership articles** and **industry-specific insights**, 
...
export default BlogWritingSupportSection;
