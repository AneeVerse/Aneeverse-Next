...
const faqs = [
  { question: "What's included in branding services?", answer: "We provide logo design, brand identity, visual identity systems, brand guidelines, brand strategy, and implementation support." },
  { question: "How long does brand development take?", answer: "Typically 4-8 weeks depending on the scope, from initial research to final brand guidelines." },
  { question: "Do you provide brand guidelines?", answer: "Yes, we create comprehensive brand guidelines covering logo usage, colors, typography, and application examples." },
  { question: "Can you rebrand existing companies?", answer: "Absolutely! We specialize in refreshing existing brands while maintaining brand equity and recognition." },
  { question: "What file formats do you provide?", answer: "We provide all necessary formats including vector files, raster files, and brand guideline PDFs." },
  { question: "Do you help with brand implementation?", answer: "Yes, we provide support for implementing your brand across all touchpoints and materials." },
  { question: "Can you create brand strategies?", answer: "Yes, we develop comprehensive brand strategies that define positioning, messaging, and market differentiation." },
];
