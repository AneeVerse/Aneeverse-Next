...
const faqs = [
  { question: "What types of copy do you write?", answer: "We write sales copy, marketing copy, website copy, ad copy, email copy, product descriptions, and brand messaging." },
  { question: "How long does copywriting take?", answer: "Timelines vary by project, typically 3-7 business days for most copywriting projects." },
  { question: "Do you provide revisions?", answer: "Yes, we include multiple revision rounds to ensure the copy meets your exact requirements." },
  { question: "Can you write in different tones?", answer: "Absolutely! We adapt our writing style to match your brand voice and target audience." },
  { question: "Do you write SEO-optimized copy?", answer: "Yes, we can write copy that's optimized for search engines while maintaining readability and engagement." },
  { question: "Can you write for different industries?", answer: "Yes, our writers have experience across various industries and can adapt to your specific needs." },
  { question: "What's included in copywriting services?", answer: "We provide research, writing, editing, revisions, and optimization for your specific channels and goals." },
];
