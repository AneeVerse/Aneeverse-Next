...
export default function GhostWritingHero() {
  return (
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh]  sm:min-h-[500px] sm:h-[75vh] flex items-center">
        {/* Background Image */}
        <Image
          src="/images/services/ghost-writing/hero-banner.avif"
          alt="Web Design Hero"
          fill
          layout="fill"
          objectFit="cover"
        ...
        <div className="relative  z-10">
          ...
          {" Your Words, Our Expertise".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2">Ghost writing Services
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Transform your ideas into compelling narratives. Our ghostwriters craft books, articles, speeches, and more—seamlessly adapting to your unique voice and style.
