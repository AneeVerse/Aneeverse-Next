...
const GhostWritingSupportSection = () => {
  return (
    <section className="bg-primary-500 py-16">
      <Layout className="flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          Need content that speaks in your voice? Our expert ghostwriters craft compelling 
          ...
          From **thought leadership articles** to **memoirs and business books**, we turn 
...
export default GhostWritingSupportSection;
