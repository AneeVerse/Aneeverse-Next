    ...
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh]  sm:min-h-[500px] sm:h-[75vh] flex items-center">
        ...
        <div className="relative  z-10">
          ...
          {"Maximize Your ROI with Google Ads".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2"> Google Ads Services
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Unlock the power of paid search with our expertly managed Google Ads campaigns. We focus on driving high-quality traffic and maximizing your ROI.
