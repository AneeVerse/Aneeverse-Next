    ...
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh] sm:h-[70vh] flex items-center">
        ...
        <div className="relative  z-10">
          ...
          {" Unlock the Power of Influencer Marketings".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2">  Influencer Marketing Services
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Expand your reach and build authentic relationships with your audience through tailored influencer marketing strategies. We help you partner with the right influencers to grow your brand.
