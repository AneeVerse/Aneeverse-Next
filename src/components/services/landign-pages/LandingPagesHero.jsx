    ...
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh]  min-h-[600px] sm:min-h-[600px] sm:h-[75vh] flex items-center">
        ...
        <div className="relative  z-10">
          ...
          {"Performance-Driven Design".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2">Landing Page Design Services</h1>
          <p className="mt-4 text-lg text-gray-200">
          High-converting landing pages crafted to maximize engagement, lead generation, and sales.
