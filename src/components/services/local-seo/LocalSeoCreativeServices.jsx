...
export default function LocalSeoCreativeServices() {
  const team = [
    {
      ...
      <section className="text-secondary-500 py-12 select-none">
        <Layout>
          ...
          <div className="text-center mb-8">
            <p className="uppercase text-sm tracking-widest">{"Boost Your Local Search Visibility".toUpperCase()}</p>
            <h2 className="text-4xl mt-3 md:text-6xl max-w-4xl mx-auto font-bold">
              <span className="italic">Local SEO</span> Services
            </h2>
          </div>
