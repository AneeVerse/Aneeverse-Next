    ...
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh]  sm:min-h-[500px] sm:h-[75vh] flex items-center">
        ...
        <div className="relative  z-10">
          ...
          {"Data-Driven Local SEO Strategies".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2">Local SEO Optimization Services
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Enhance your local search presence with our expert local SEO services. We optimize your business for local visibility and drive targeted traffic from your area.
          </p>
          <Link href="/contact">
