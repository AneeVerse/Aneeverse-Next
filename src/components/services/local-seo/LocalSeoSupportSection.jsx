    ...
    <section className="bg-primary-500 py-16">
      <Layout className="flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          Stand out in local searches and attract the right customers with our tailored local SEO services.
          ...
          From **GMB profile enhancements** to **local backlinks** and **geo-targeted content**,  
...
export default LocalSeoSupportSection;
