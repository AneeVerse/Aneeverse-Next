...
const statsData = [
  ...
  export default function MarketingStrategyStateSection() {
    return (
      <div className="bg-secondary-500 text-primary-500 pb-0 pt-5 md:pt-12 md:pb-12 ">
       <Layout>
         {/* Heading */}
         <div className="text-center mb-8">
            <p className="uppercase text-sm tracking-widest">SUCCESS METRICS</p>
            <h2 className="text-3xl mt-3 mb-4 md:text-5xl max-w-4xl mx-auto font-semibold">
          <span className="font-Rock_Salt text-2xl md:text-4xl">measurable results</span>  with Superside's marketing consultants
            </h2>
          </div>
