  ...
  return (
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh] sm:h-[70vh] flex items-center">
        {/* Background Image */}
        <Image
          src="/images/services/meta-ads/hero-banner.avif"
          alt="Web Design Hero"
          fill
          layout="fill"
          objectFit="cover"
        ...
        <div className="relative  z-10">
          ...
          {" Maximize Your Meta Ads Impact".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2"> Meta Ads Services
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Drive targeted traffic, boost conversions, and scale your business with our Meta Ads services. From ad creation to performance analysis, we help you leverage Meta’s advertising platform for optimal results.
