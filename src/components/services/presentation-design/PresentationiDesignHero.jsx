...
export default function PresentationiDesignHero() {
  return (
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh] sm:h-[70vh] flex items-center">
        {/* Background Image */}
        <Image
          src="/images/services/presentation-design/hero-banner.avif"
          alt="Web Design Hero"
          fill
          layout="fill"
          objectFit="cover"
        ...
        <div className="relative  z-10">
          ...
          {"Impactful Presentation Design".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2"> Presentation Designs
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Create visually compelling and engaging presentations that resonate with your audience.
