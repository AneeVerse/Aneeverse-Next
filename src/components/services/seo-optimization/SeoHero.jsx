    ...
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh] sm:h-[70vh] flex items-center">
        ...
        <div className="relative  z-10">
          ...
          {" Data-Driven SEO Strategies".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2">SEO Optimization Services
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Maximize your search engine visibility with our cutting-edge SEO techniques.
