    ...
    <div className="relative -mt-[80px] text-white overflow-hidden">
      ...
      <div className="relative w-full h-[90vh] sm:h-[70vh] flex items-center">
        ...
        <div className="relative  z-10">
          ...
          {"Engaging Visuals, Maximum Reach".toUpperCase()}
          </p>
          <h1 className="text-5xl md:text-6xl w-full block font-bold mt-2">Social Media Creatives
          </h1>
          <p className="mt-4 text-lg text-gray-200">
          Grab attention with high-impact social media visuals. Our creatives are designed to
